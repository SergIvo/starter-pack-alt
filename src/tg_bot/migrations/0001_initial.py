    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(db_index=True, default=django.utils.timezone.now, help_text='Когда была создана сессия. Обычно, сессия создаётся при первом сообщении от пользователя к чат-боту.', verbose_name='Когда создана')),
